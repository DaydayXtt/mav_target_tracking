...
class Autopilot:
	...
	#### TODO #####
        ...
        phi_c = self.saturate(cmd.phi_feedforward + self.course_from_roll.update(chi_c, state.chi), -np.radians(60),
                              np.radians(60))
        ...
        altitude_c = self.saturate(cmd.altitude_command, cmd.altitude_command - AP.altitude_zone,
                                   cmd.altitude_command + AP.altitude_zone)
        ...
        delta = MsgDelta(elevator=delta_e,
                         ...
                         rudder=delta_r,
                         throttle=delta_t)
        self.commanded_state.altitude = altitude_c
